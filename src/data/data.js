const moduleSubjectCodes = [
  ...
  "Entrepreneurship for Translational Medicine Researchers","Networking in International Translational Medicine",
  "Thesis",
  ...
  export const allModules = moduleCodes.map((code, i) => {
