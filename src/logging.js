...
export const updateIVsForLogging = (condition) => {
  IVs = condition;
  FILTERNG_TECHNIQUE = IVs.IV1;
  NUMBER_OF_MODULES_SELECTED = IVs.IV2;
  PRESENCE_OF_MODULE_CART_IN_CATALOG = IVs.IV3;
};
...
function logEvent(event, eventCount) {
  ...
  sendNetworkLog(
    ...
    time,
    FILTERNG_TECHNIQUE,
    NUMBER_OF_MODULES_SELECTED,
    PRESENCE_OF_MODULE_CART_IN_CATALOG,
    event,
    eventCount
  );
}
